                    ...
                    Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: Get.height*0.04,),
                          _.processing?CircularProgressIndicator(color: Colors.black,):CustomTextButton(text:"Send Support message",width: 250,textSize: 12,onTap: ()async{
                            await _.sendSupportMessage();
